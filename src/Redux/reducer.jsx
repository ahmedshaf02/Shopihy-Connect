...
export const initState = {
  productData:[
    ...
    {name:"Modular Sofa",cost:175,company:"Gubi",id:"RC-P110",qty:1,desc:"Menu Designed by Norm Architects. Inspired by architecture, Eave Modular Sofa takes its name from",select:"Accessories",imageUrl:"https://cdn.shopify.com/s/files/1/0053/2792/products/EaveCornerModuleRotated.png"},
    ...
    {name:"Reverse Table Lamp",cost:409,company:"Hay",id:"RC-P103",qty:1,desc:"Designed by Alvar Aalto. Wall Light A330S “Golden Bell” is a complement to Alvar Aalto’s popular sculptural pendant light.",select:"Accessories",imageUrl:"https://hausimg.imgix.net/s/files/1/0053/2792/products/ReverseTableLamp.png?v=1588926891&auto=format&w=1280&"},
    {
      id: "RC-P161",
      company: "K-Active",
      name: "Marled Mini Dress",
      cost: 450,
      qty:1,desc:"Designed by Alvar Aalto. Wall Light A330S “Golden Bell” is a complement to Alvar Aalto’s popular sculptural pendant light.",
      select:"Women",
      offer: "50 % OFF",
      imageUrl: "https://www.forever21.com/images/default_330/00378023-04.jpg"
    },
    {
      id: "m101",
      qty:1,
      company: "Marled",
      desc: "Men Maroon & Navy Blue Striped Round Neck T-shirt",
      name: "Men Maroon T-shirt",
      cost: 450,
      select: "Mens",
      imageUrl:
    ...
    {
      id: "k103",
      name: "Green & Off-White Tropical Print",
      company: "Privy League",
      desc: "Girls Sea Green & Off-White Tropical Print Fit and Flare Dress",
      cost: 1070,
      select:"Kids",
      qty: 1,
      imageUrl: "https://www.forever21.com/images/default_330/00398579-06.jpg"
    },
